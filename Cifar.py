...
loader = DataLoader(dataset=custom_dataset, batch_size=8, shuffle=False)

images, labels = next(iter(loader))
images = denormalize(images, mean, std) #특정 픽셀의 값이 유효범위인 [0,1]을 벗어날 수 있기에 강제함
